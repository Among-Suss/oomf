...
FFMPEG_OPTIONS = {'before_options': '-f concat -i cogs/res/silence.opus -reconnect 1 -reconnect_streamed 1 -reconnect_delay_max 5', 'options': f'-vn -packet_loss 10 -blocksize {io.DEFAULT_BUFFER_SIZE * 4}'}
